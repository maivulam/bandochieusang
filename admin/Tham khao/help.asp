...
<!--
function xemthu(st){
  window.open("viewmessage.asp?stt="+st+"",'winpopup','height=400,width=300,menubar=no,scrollbars=yes,status=no,toolbar=no,screenX=100,screenY=0,left100,top=0');
  }  
//-->
</SCRIPT>
<title>All message receive from user</title>
</head>
<body >
...
<tr>
 ...
 <td width="40%" valign="top">
  <font face="verdana" size=2><b>
   [ <a href="viewmember.asp">View Member</a> |<a href="burn.asp"> CDROM burning</a>|<a href="notburn.asp">CDROM not burn </a>|<a href="guest.asp"> Guest </a>| Help ]
  </b></font>
 </td>
...
<tr bgcolor="#7777ff">
  ...
  <td><font face=verdana size=2><b>Reply</b></font></td>
</tr>
<%
dem=1;
while(!RS.EOF){
...
<tr bgcolor=<%=maunen%>>
  ...
  <td><font face=verdana size=2><b><%=RS("email")%></b></font></td>
  <td><font face=verdana size=2><b><a href="javascript:xemthu(<%=RS("stt")+""%>)"><%=RS("chude")%></a></b></font></td>
  <td><font face=verdana size=2><b><%=RS("ngayhoi")%></b></font></td>
  <td><font face=verdana size=2><b><%=RS("traloi")%></b></font></td>
 </tr>
<%
 dem++;
 RS.MoveNext(); 
