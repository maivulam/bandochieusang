...
<script type="text/javascript" src="https://maps.googleapis.com/maps/api/js?key=AIzaSyD_Se5Y0hUjMpYoffQaVrCZQ-__QixdxIg&libraries=geometry&callback=initMap">
</script>
...
alert("browserSupportFlag: " + browserSupportFlag);
    });
