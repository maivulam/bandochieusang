...
sql="select * from cdrom where xongcdr=0";
...
<title>All CDROM not burn now</title>
</head>
<body>
...
<tr>
 ...
 <td width="40%" valign="top">
  <font face="verdana" size=2><b>
   [ <a href="viewmember.asp">View Member</a> |<a href="burn.asp">CDROM burning </a>| CDROM not burn |<a href="guest.asp">Guest</a>| <a href="help.asp">Help</a>]
  </b></font>
 </td>
...
<tr bgcolor="#7777ff">
  ...
  <td><font face=verdana size=2><b>Burn now</b></font></td>
...
<tr bgcolor=<%=maunen%>>
  ...
  <td><font face=verdana size=2><b><a href="javascript:viewcdrom('<%=RS('macdr')+''%>')"><%=RS("tencdr")%></a></b></font></td>
  ...
  <td><font face=verdana size=2><b><a href="burnnow.asp?id=<%=RS("macdr")+""%>">Burn</a></b></font></td>
  <td><font face=verdana size=2><b><a href="delcdrom.asp?id=<%=RS("macdr")+""%>">Del</a></b></font></td>
</tr>
<%
 dem++;
 RS.MoveNext(); 
